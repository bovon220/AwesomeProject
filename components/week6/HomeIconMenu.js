  ...
  return (
    <View style={{ marginHorizontal: 20, marginTop: -50, padding: 20, borderWidth: 1, borderColor: 'gray', borderRadius: 20, backgroundColor: 'white' }}>
      ...
      <View style={{ flexDirection: "row", marginTop: 10, justifyContent: "space-around" }}>
        ...
        <MyIcon title="resort" name="bed" size={30} color="orange"
          onPress={() => { navigation.navigate("Resort"); }} />
        <MyIcon title="health" name="heart" size={30} color="orange"
      ...
      <View style={{ flexDirection: "row", marginTop: 10, justifyContent: "space-around" }}>
        <MyIcon title="Pokemon" name="bolt" size={30} color="orange"
          onPress={() => { navigation.navigate("PokemonTab"); }} />
